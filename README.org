...
2018-06-02       kleymik - Treacl yet another variation on similar datatypes in various interpreted languages.
2010-02-01 16:32 kleymik tdict.py python2 tree dict
...
-  standard_model.py - particle physics, gluons, leptons, etc, a graph of how they group and interact
                       illustrates using getProp and addProp since normal attributes
...
- defaultdict: automatically intialises new key values in dicts, rather thas instance attributes
...
- option for automatcially including backpointers?
